...
The ball-by-ball (bbb) cricket data is inherently an event sequence structure which we can index by balls or overs. In this section I aim to demonstrate that structure and investigate any interesting features. Bukiet [5] has an interesting approach to trying to model this time dependent structure of cricket by using Markov Chains.
...
[5] Bukiet B, Ovens M. A mathematical modelling approach to one-day cricket batting orders. J Sports Sci Med. 2006
